 ...
 * 
 */
public class SyncModelProcessorFactory extends ModelProcessorFactory {

	/**
	 * 
	 */
	public SyncModelProcessorFactory() {
	}
	...
	public AnnotationProcessor getProcessorFor(
		...
		return new SyncModelProcessor(annotationTypeDeclarations, env);
	}
}